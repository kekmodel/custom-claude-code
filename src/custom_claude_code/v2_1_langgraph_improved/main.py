"""
v2.1: LangGraph 메인 실행 루프 (Improved)

개선 사항:
- EventHandler 단순화 (depth tracking 제거)
- callbacks=[] 신뢰로 subagent 이벤트 자동 필터링
- Spinner 관리 간소화
...
async def run_conversation_loop():
    ...
    console.print(
        Panel(
            "[bold]Custom Claude Code - Version 2.1: LangGraph Improved[/bold]\n\n" "Commands: quit, clear, graph",
            title="Welcome",
            border_style="magenta",
        )
    )
